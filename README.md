...
<p>Web Page Project - Markup Language - Final First Term Evaluation</p>
<p>December 2023</p>
<p> License CC-BY</p>
...
<p>My web is divided into 9 sections</p>
<ul>
  <li>Hero Section</li>  
  <li>Contents</li>
...
<h3>Hero Section</h3>
<img src="" alt="Hero Section Image Alan Turing" style="width:50%">
...
<p>The section is divided into a blockquote section in the upper portion of the section and a grid layout of 3 cards which alter from a 33%/33%/33% layout
in PCs down to a 100% one column layout in mobile phones to achieve responsiveness in different screen sizes. The cards containing images act as a Contents
menu which when clicked on lead directly to one of the three subsections: The Biography, The Bombe & Other Inventions.</p>
<p></p>
...
<p>This subsection contains a basic two grid layout with a black and white portrait of Alan Turing and introduction paragraph of his biography There also a Read More button (styled
...
<h3>(2)The Bombe</h3>
<p> This subsection contains a grid layout containing a video by Mr Special History) & its the corrsponding link to YouTube and in addition, related text. The Read More button links 
 to an article written by the National Museum of Computingreviewing the book released on the same topic "The Bombe: The Machine that defeated Enigma" by the author Dermot Turing.</p>
...
corresponding link to Youtube and an image containing a portrait of Alan Turing and the Apple logo. Upon clicking, the image links to an article written by Manchester´s Finest titled "Myths of
Manchestter: The Apple Logo & Alan Turing."</p>
...
<h2 id="pagestyle">Estilo de la página</h2>
